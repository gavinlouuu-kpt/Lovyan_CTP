...
// SPIバスの設定
      ...
      cfg.pin_miso = 21;            // SPIのMISOピン番号を設定 (-1 = disable)
...
// SPI接続の場合
      ...
      cfg.pin_sclk = 4;     // SCLKが接続されているピン番号
      cfg.pin_mosi = 19;     // MOSIが接続されているピン番号
      cfg.pin_miso = 21;     // MISOが接続されているピン番号
      cfg.pin_cs   =  18;     //   CSが接続されているピン番号

// I2C接続の場合
      cfg.i2c_port = 1;      // 使用するI2Cを選択 (0 or 1)
      cfg.i2c_addr = 0x38;   // I2Cデバイスアドレス番号
      cfg.pin_sda  = 32;     // SDAが接続されているピン番号
      cfg.pin_scl  = 33;     // SCLが接続されているピン番号
